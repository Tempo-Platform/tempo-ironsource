...
struct TempoConstants {
    ...
    static let ADS_DOM_URL_PROD = "https://ads.tempoplatform.com" // DEV
    ...
    static let ADS_DOM_URL_DEV = "https://development--tempo-html-ads.netlify.app"
